...
//        self.image = [UIImage sd_animatedGIFWithData:imageData];
...
//    }
    ...
    [self sd_setImageWithPreviousCachedImageWithURL:url andPlaceholderImage:placeholder options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
