#define deslabelFont [UIFont systemFontOfSize:13 ]
...
//            NSLog(@"%@",self.text);
                    ...
                    endLabel.text = @"%";
                    NSString * strContinu = [NSString stringWithFormat:@"%@%@",self.text,endLabel.text];
                    NSMutableAttributedString * watchAtt = [[NSMutableAttributedString alloc]initWithString:strContinu];
                    [watchAtt addAttribute:NSFontAttributeName value:deslabelFont range:NSMakeRange(strContinu.length-1, [endLabel.text length])];
            //        UILabel * lable = [[UILabel alloc]init];
            //        lable.text = watchAtt;
            self.attributedText = watchAtt;
